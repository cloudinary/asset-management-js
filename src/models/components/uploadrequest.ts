...
export type UploadRequest = {
   ...
   * Relevant for images only.
   */
  backgroundRemoval?: UploadRequestBackgroundRemoval | undefined;
  /**
...
/** @internal */
export const UploadRequestType$inboundSchema: z.ZodNativeEnum<
  typeof UploadRequestType
> = z.nativeEnum(UploadRequestType);

/** @internal */
export const UploadRequestType$outboundSchema: z.ZodNativeEnum<
  typeof UploadRequestType
> = UploadRequestType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UploadRequestType$ {
  /** @deprecated use `UploadRequestType$inboundSchema` instead. */
  export const inboundSchema = UploadRequestType$inboundSchema;
  /** @deprecated use `UploadRequestType$outboundSchema` instead. */
  export const outboundSchema = UploadRequestType$outboundSchema;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UploadRequestAccessMode$ {
  /** @deprecated use `UploadRequestAccessMode$inboundSchema` instead. */
  export const inboundSchema = UploadRequestAccessMode$inboundSchema;
  /** @deprecated use `UploadRequestAccessMode$outboundSchema` instead. */
  export const outboundSchema = UploadRequestAccessMode$outboundSchema;
}

/** @internal */
export const UploadRequestCategorization$inboundSchema: z.ZodNativeEnum<
  typeof UploadRequestCategorization
> = z.nativeEnum(UploadRequestCategorization);

/** @internal */
export const UploadRequestCategorization$outboundSchema: z.ZodNativeEnum<
  typeof UploadRequestCategorization
> = UploadRequestCategorization$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UploadRequestCategorization$ {
  /** @deprecated use `UploadRequestCategorization$inboundSchema` instead. */
  export const inboundSchema = UploadRequestCategorization$inboundSchema;
  /** @deprecated use `UploadRequestCategorization$outboundSchema` instead. */
  export const outboundSchema = UploadRequestCategorization$outboundSchema;
}
...
/** @internal */
export const UploadRequestBackgroundRemoval$inboundSchema: z.ZodNativeEnum<
  typeof UploadRequestBackgroundRemoval
> = z.nativeEnum(UploadRequestBackgroundRemoval);

/** @internal */
export const UploadRequestBackgroundRemoval$outboundSchema: z.ZodNativeEnum<
  typeof UploadRequestBackgroundRemoval
> = UploadRequestBackgroundRemoval$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UploadRequestBackgroundRemoval$ {
  /** @deprecated use `UploadRequestBackgroundRemoval$inboundSchema` instead. */
  export const inboundSchema = UploadRequestBackgroundRemoval$inboundSchema;
  /** @deprecated use `UploadRequestBackgroundRemoval$outboundSchema` instead. */
  export const outboundSchema = UploadRequestBackgroundRemoval$outboundSchema;
}
