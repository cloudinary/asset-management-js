 ...
 */
export const BinaryUploadRequestModeration = {
  Manual: "manual",
  Webpurify: "webpurify",
  Metascan: "metascan",
  AwsRek: "aws_rek",
 ...
 * Note: Rejected assets are automatically invalidated on the CDN within approximately ten minutes.
 */
export type BinaryUploadRequestModeration = ClosedEnum<
  typeof BinaryUploadRequestModeration
>;

export type BinaryUploadRequestResponsiveBreakpoint = {
 ...
 */
export const BinaryUploadRequestType = {
  Upload: "upload",
 ...
 * The delivery type that defines if and how the uploaded asset is available for public delivery. By default, all uploaded assets are public (upload). Possible values are upload, authenticated, private or asset.
 */
export type BinaryUploadRequestType = ClosedEnum<
  typeof BinaryUploadRequestType
>;
 ...
 */
export const BinaryUploadRequestAccessMode = {
  Public: "public",
  Authenticated: "authenticated",
} as const;
/**
 ...
 * @deprecated enum: The access_mode parameter is no longer supported. To restrict access to assets, you can use the access_control parameter.. Use accessControl instead.
 */
export type BinaryUploadRequestAccessMode = ClosedEnum<
  typeof BinaryUploadRequestAccessMode
>;
 ...
 */
export const BinaryUploadRequestCategorization = {
 ...
 * A comma-separated list of the categorization add-ons to run on the asset. Set to google_tagging, google_video_tagging, imagga_tagging and/or aws_rek_tagging to automatically classify the scenes of the uploaded asset.
 */
export type BinaryUploadRequestCategorization = ClosedEnum<
  typeof BinaryUploadRequestCategorization
>;
 ...
 */
export const BinaryUploadRequestOcr = {
  AdvOcr: "adv_ocr",
} as const;
/**
 * Set to adv_ocr to extract all text elements in an image as well as the bounding box coordinates of each detected element using the OCR text detection and extraction add-on.
 */
export type BinaryUploadRequestOcr = ClosedEnum<typeof BinaryUploadRequestOcr>;
 ...
 */
export const BinaryUploadRequestBackgroundRemoval = {
 ...
 * Relevant for images only.
 */
export type BinaryUploadRequestBackgroundRemoval = ClosedEnum<
  typeof BinaryUploadRequestBackgroundRemoval
>;
...
export type BinaryUploadRequest = {
  /**
   ...
   * Note: Rejected assets are automatically invalidated on the CDN within approximately ten minutes.
   */
  moderation?: BinaryUploadRequestModeration | undefined;
  /**
  ...
  responsiveBreakpoints?:
    | Array<BinaryUploadRequestResponsiveBreakpoint>
    | undefined;
  /**
   ...
   * The delivery type that defines if and how the uploaded asset is available for public delivery. By default, all uploaded assets are public (upload). Possible values are upload, authenticated, private or asset.
   */
  type?: BinaryUploadRequestType | undefined;
  /**
   * Allows the asset to behave as if it's of the authenticated 'type' (see above) while still using the default 'upload' type in delivery URLs. The asset can later be made public by changing its access_mode via the Admin API, without having to update any delivery URLs. Valid values: public, and authenticated.
   *
   * @remarks
   ...
   */
  accessMode?: BinaryUploadRequestAccessMode | undefined;
  /**
   * A comma-separated list of the categorization add-ons to run on the asset. Set to google_tagging, google_video_tagging, imagga_tagging and/or aws_rek_tagging to automatically classify the scenes of the uploaded asset.
   */
  categorization?: BinaryUploadRequestCategorization | undefined;
  /**
   * Set to adv_ocr to extract all text elements in an image as well as the bounding box coordinates of each detected element using the OCR text detection and extraction add-on.
   */
  ocr?: BinaryUploadRequestOcr | undefined;
  /**
   ...
   * Relevant for images only.
   */
  backgroundRemoval?: BinaryUploadRequestBackgroundRemoval | undefined;
  /**
...
/** @internal */
export const BinaryUploadRequestModeration$inboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestModeration
> = z.nativeEnum(BinaryUploadRequestModeration);

/** @internal */
export const BinaryUploadRequestModeration$outboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestModeration
> = BinaryUploadRequestModeration$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequestModeration$ {
  /** @deprecated use `BinaryUploadRequestModeration$inboundSchema` instead. */
  export const inboundSchema = BinaryUploadRequestModeration$inboundSchema;
  /** @deprecated use `BinaryUploadRequestModeration$outboundSchema` instead. */
  export const outboundSchema = BinaryUploadRequestModeration$outboundSchema;
}

/** @internal */
export const BinaryUploadRequestResponsiveBreakpoint$inboundSchema: z.ZodType<
  BinaryUploadRequestResponsiveBreakpoint,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type BinaryUploadRequestResponsiveBreakpoint$Outbound = {
...
/** @internal */
export const BinaryUploadRequestResponsiveBreakpoint$outboundSchema: z.ZodType<
  BinaryUploadRequestResponsiveBreakpoint$Outbound,
  z.ZodTypeDef,
  BinaryUploadRequestResponsiveBreakpoint
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequestResponsiveBreakpoint$ {
  /** @deprecated use `BinaryUploadRequestResponsiveBreakpoint$inboundSchema` instead. */
  export const inboundSchema =
    BinaryUploadRequestResponsiveBreakpoint$inboundSchema;
  /** @deprecated use `BinaryUploadRequestResponsiveBreakpoint$outboundSchema` instead. */
  export const outboundSchema =
    BinaryUploadRequestResponsiveBreakpoint$outboundSchema;
  /** @deprecated use `BinaryUploadRequestResponsiveBreakpoint$Outbound` instead. */
  export type Outbound = BinaryUploadRequestResponsiveBreakpoint$Outbound;
}

export function binaryUploadRequestResponsiveBreakpointToJSON(
  binaryUploadRequestResponsiveBreakpoint:
    BinaryUploadRequestResponsiveBreakpoint,
): string {
  return JSON.stringify(
    BinaryUploadRequestResponsiveBreakpoint$outboundSchema.parse(
      binaryUploadRequestResponsiveBreakpoint,
    ),
  );
}

export function binaryUploadRequestResponsiveBreakpointFromJSON(
  jsonString: string,
): SafeParseResult<
  BinaryUploadRequestResponsiveBreakpoint,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      BinaryUploadRequestResponsiveBreakpoint$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'BinaryUploadRequestResponsiveBreakpoint' from JSON`,
  );
}

/** @internal */
export const BinaryUploadRequestType$inboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestType
> = z.nativeEnum(BinaryUploadRequestType);

/** @internal */
export const BinaryUploadRequestType$outboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestType
> = BinaryUploadRequestType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequestType$ {
  /** @deprecated use `BinaryUploadRequestType$inboundSchema` instead. */
  export const inboundSchema = BinaryUploadRequestType$inboundSchema;
  /** @deprecated use `BinaryUploadRequestType$outboundSchema` instead. */
  export const outboundSchema = BinaryUploadRequestType$outboundSchema;
}

/** @internal */
export const BinaryUploadRequestAccessMode$inboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestAccessMode
> = z.nativeEnum(BinaryUploadRequestAccessMode);

/** @internal */
export const BinaryUploadRequestAccessMode$outboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestAccessMode
> = BinaryUploadRequestAccessMode$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequestAccessMode$ {
  /** @deprecated use `BinaryUploadRequestAccessMode$inboundSchema` instead. */
  export const inboundSchema = BinaryUploadRequestAccessMode$inboundSchema;
  /** @deprecated use `BinaryUploadRequestAccessMode$outboundSchema` instead. */
  export const outboundSchema = BinaryUploadRequestAccessMode$outboundSchema;
}

/** @internal */
export const BinaryUploadRequestCategorization$inboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestCategorization
> = z.nativeEnum(BinaryUploadRequestCategorization);

/** @internal */
export const BinaryUploadRequestCategorization$outboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestCategorization
> = BinaryUploadRequestCategorization$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequestCategorization$ {
  /** @deprecated use `BinaryUploadRequestCategorization$inboundSchema` instead. */
  export const inboundSchema = BinaryUploadRequestCategorization$inboundSchema;
  /** @deprecated use `BinaryUploadRequestCategorization$outboundSchema` instead. */
  export const outboundSchema =
    BinaryUploadRequestCategorization$outboundSchema;
}

/** @internal */
export const BinaryUploadRequestOcr$inboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestOcr
> = z.nativeEnum(BinaryUploadRequestOcr);

/** @internal */
export const BinaryUploadRequestOcr$outboundSchema: z.ZodNativeEnum<
  typeof BinaryUploadRequestOcr
> = BinaryUploadRequestOcr$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequestOcr$ {
  /** @deprecated use `BinaryUploadRequestOcr$inboundSchema` instead. */
  export const inboundSchema = BinaryUploadRequestOcr$inboundSchema;
  /** @deprecated use `BinaryUploadRequestOcr$outboundSchema` instead. */
  export const outboundSchema = BinaryUploadRequestOcr$outboundSchema;
}

/** @internal */
export const BinaryUploadRequestBackgroundRemoval$inboundSchema:
  z.ZodNativeEnum<typeof BinaryUploadRequestBackgroundRemoval> = z.nativeEnum(
    BinaryUploadRequestBackgroundRemoval,
  );

/** @internal */
export const BinaryUploadRequestBackgroundRemoval$outboundSchema:
  z.ZodNativeEnum<typeof BinaryUploadRequestBackgroundRemoval> =
    BinaryUploadRequestBackgroundRemoval$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequestBackgroundRemoval$ {
  /** @deprecated use `BinaryUploadRequestBackgroundRemoval$inboundSchema` instead. */
  export const inboundSchema =
    BinaryUploadRequestBackgroundRemoval$inboundSchema;
  /** @deprecated use `BinaryUploadRequestBackgroundRemoval$outboundSchema` instead. */
  export const outboundSchema =
    BinaryUploadRequestBackgroundRemoval$outboundSchema;
}
...
/** @internal */
export const BinaryUploadRequest$inboundSchema: z.ZodType<
  BinaryUploadRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  moderation: BinaryUploadRequestModeration$inboundSchema.optional(),
  ...
  responsive_breakpoints: z.array(
    z.lazy(() => BinaryUploadRequestResponsiveBreakpoint$inboundSchema),
  ).optional(),
  ...
  type: BinaryUploadRequestType$inboundSchema.optional(),
  access_mode: BinaryUploadRequestAccessMode$inboundSchema.optional(),
  categorization: BinaryUploadRequestCategorization$inboundSchema.optional(),
  ocr: BinaryUploadRequestOcr$inboundSchema.optional(),
  raw_convert: z.string().optional(),
  background_removal: BinaryUploadRequestBackgroundRemoval$inboundSchema
    .optional(),
...
/** @internal */
export type BinaryUploadRequest$Outbound = {
  signature?: string | undefined;
  timestamp?: number | undefined;
  ...
  responsive_breakpoints?:
    | Array<BinaryUploadRequestResponsiveBreakpoint$Outbound>
    | undefined;
  tags?: string | undefined;
  callback?: string | undefined;
  backup?: boolean | undefined;
...
/** @internal */
export const BinaryUploadRequest$outboundSchema: z.ZodType<
  BinaryUploadRequest$Outbound,
  z.ZodTypeDef,
  BinaryUploadRequest
> = z.object({
  signature: z.string().optional(),
  ...
  metadata: z.string().optional(),
  moderation: BinaryUploadRequestModeration$outboundSchema.optional(),
  notificationUrl: z.string().optional(),
  phash: z.boolean().optional(),
  qualityAnalysis: z.boolean().optional(),
  regions: z.string().optional(),
  responsiveBreakpoints: z.array(
    z.lazy(() => BinaryUploadRequestResponsiveBreakpoint$outboundSchema),
  ).optional(),
  tags: z.string().optional(),
  callback: z.string().optional(),
  backup: z.boolean().optional(),
  ...
  type: BinaryUploadRequestType$outboundSchema.optional(),
  accessMode: BinaryUploadRequestAccessMode$outboundSchema.optional(),
  categorization: BinaryUploadRequestCategorization$outboundSchema.optional(),
  ocr: BinaryUploadRequestOcr$outboundSchema.optional(),
  rawConvert: z.string().optional(),
  backgroundRemoval: BinaryUploadRequestBackgroundRemoval$outboundSchema
    .optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BinaryUploadRequest$ {
  /** @deprecated use `BinaryUploadRequest$inboundSchema` instead. */
  export const inboundSchema = BinaryUploadRequest$inboundSchema;
  /** @deprecated use `BinaryUploadRequest$outboundSchema` instead. */
  export const outboundSchema = BinaryUploadRequest$outboundSchema;
  /** @deprecated use `BinaryUploadRequest$Outbound` instead. */
  export type Outbound = BinaryUploadRequest$Outbound;
}

export function binaryUploadRequestToJSON(
  binaryUploadRequest: BinaryUploadRequest,
): string {
  return JSON.stringify(
    BinaryUploadRequest$outboundSchema.parse(binaryUploadRequest),
  );
}

export function binaryUploadRequestFromJSON(
  jsonString: string,
): SafeParseResult<BinaryUploadRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => BinaryUploadRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BinaryUploadRequest' from JSON`,
  );
}
