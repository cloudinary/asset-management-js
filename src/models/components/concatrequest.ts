 ...
 */
export type ConcatRequestAutoTranscription = {
  /**
...
export type ConcatRequestAutoTranscriptionUnion =
  | boolean
 ...
 */
export const ConcatRequestAccessMode = {
  Public: "public",
 ...
 * @deprecated enum: The access_mode parameter is no longer supported. To restrict access to assets, you can use the access_control parameter.. Use accessControl instead.
 */
export type ConcatRequestAccessMode = ClosedEnum<
  typeof ConcatRequestAccessMode
>;
 ...
 */
export type ConcatRequestRegions = string | {
 ...
 */
export type ConcatRequestResponsiveBreakpoints =
  | Array<ResponsiveBreakpoint>
  | ResponsiveBreakpoint;

/**
 * Parameters for concatenating remote video segments into a single MP4 asset.
 */
export type ConcatRequest = {
  ...
  autoTranscription?: boolean | ConcatRequestAutoTranscription | undefined;
  /**
   ...
   */
  accessMode?: ConcatRequestAccessMode | undefined;
  /**
  ...
  /**
   * Ordered list of HTTP(S) URLs of the video segments to concatenate.
   */
  urls: Array<string>;
};

/** @internal */
export const ConcatRequestAutoTranscription$inboundSchema: z.ZodType<
  ConcatRequestAutoTranscription,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type ConcatRequestAutoTranscription$Outbound = {
  translate?: Array<string> | undefined;
};

/** @internal */
export const ConcatRequestAutoTranscription$outboundSchema: z.ZodType<
  ConcatRequestAutoTranscription$Outbound,
  z.ZodTypeDef,
  ConcatRequestAutoTranscription
> = z.object({
  translate: z.array(z.string()).optional(),
...
export function concatRequestAutoTranscriptionToJSON(
  concatRequestAutoTranscription: ConcatRequestAutoTranscription,
): string {
  return JSON.stringify(
    ConcatRequestAutoTranscription$outboundSchema.parse(
      concatRequestAutoTranscription,
    ),
  );
}
export function concatRequestAutoTranscriptionFromJSON(
  jsonString: string,
): SafeParseResult<ConcatRequestAutoTranscription, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ConcatRequestAutoTranscription$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ConcatRequestAutoTranscription' from JSON`,
  );
}

/** @internal */
export const ConcatRequestAutoTranscriptionUnion$inboundSchema: z.ZodType<
  ConcatRequestAutoTranscriptionUnion,
  z.ZodTypeDef,
  unknown
> = z.union([
  z.boolean(),
  z.lazy(() => ConcatRequestAutoTranscription$inboundSchema),
]);
/** @internal */
export type ConcatRequestAutoTranscriptionUnion$Outbound =
  | boolean
  | ConcatRequestAutoTranscription$Outbound;

/** @internal */
export const ConcatRequestAutoTranscriptionUnion$outboundSchema: z.ZodType<
  ConcatRequestAutoTranscriptionUnion$Outbound,
  z.ZodTypeDef,
  ConcatRequestAutoTranscriptionUnion
> = z.union([
  z.boolean(),
  z.lazy(() => ConcatRequestAutoTranscription$outboundSchema),
]);

export function concatRequestAutoTranscriptionUnionToJSON(
  concatRequestAutoTranscriptionUnion: ConcatRequestAutoTranscriptionUnion,
): string {
  return JSON.stringify(
    ConcatRequestAutoTranscriptionUnion$outboundSchema.parse(
      concatRequestAutoTranscriptionUnion,
    ),
  );
}
export function concatRequestAutoTranscriptionUnionFromJSON(
  jsonString: string,
): SafeParseResult<ConcatRequestAutoTranscriptionUnion, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ConcatRequestAutoTranscriptionUnion$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ConcatRequestAutoTranscriptionUnion' from JSON`,
  );
}

/** @internal */
export const ConcatRequestAccessMode$inboundSchema: z.ZodNativeEnum<
  typeof ConcatRequestAccessMode
> = z.nativeEnum(ConcatRequestAccessMode);
/** @internal */
export const ConcatRequestAccessMode$outboundSchema: z.ZodNativeEnum<
  typeof ConcatRequestAccessMode
> = ConcatRequestAccessMode$inboundSchema;

/** @internal */
export const ConcatRequestRegions$inboundSchema: z.ZodType<
  ConcatRequestRegions,
  z.ZodTypeDef,
  unknown
> = z.union([z.string(), z.record(z.array(z.array(z.number().int())))]);
/** @internal */
export type ConcatRequestRegions$Outbound = string | {
  [k: string]: Array<Array<number>>;
};

/** @internal */
export const ConcatRequestRegions$outboundSchema: z.ZodType<
  ConcatRequestRegions$Outbound,
  z.ZodTypeDef,
  ConcatRequestRegions
> = z.union([z.string(), z.record(z.array(z.array(z.number().int())))]);

export function concatRequestRegionsToJSON(
  concatRequestRegions: ConcatRequestRegions,
): string {
  return JSON.stringify(
    ConcatRequestRegions$outboundSchema.parse(concatRequestRegions),
  );
}
export function concatRequestRegionsFromJSON(
  jsonString: string,
): SafeParseResult<ConcatRequestRegions, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ConcatRequestRegions$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ConcatRequestRegions' from JSON`,
  );
}

/** @internal */
export const ConcatRequestResponsiveBreakpoints$inboundSchema: z.ZodType<
...
/** @internal */
export type ConcatRequestResponsiveBreakpoints$Outbound =
  | Array<ResponsiveBreakpoint$Outbound>
  | ResponsiveBreakpoint$Outbound;

/** @internal */
export const ConcatRequestResponsiveBreakpoints$outboundSchema: z.ZodType<
  ConcatRequestResponsiveBreakpoints$Outbound,
  z.ZodTypeDef,
  ConcatRequestResponsiveBreakpoints
> = z.union([
...
export function concatRequestResponsiveBreakpointsToJSON(
  concatRequestResponsiveBreakpoints: ConcatRequestResponsiveBreakpoints,
): string {
  return JSON.stringify(
    ConcatRequestResponsiveBreakpoints$outboundSchema.parse(
      concatRequestResponsiveBreakpoints,
    ),
  );
}
export function concatRequestResponsiveBreakpointsFromJSON(
  jsonString: string,
): SafeParseResult<ConcatRequestResponsiveBreakpoints, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ConcatRequestResponsiveBreakpoints$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ConcatRequestResponsiveBreakpoints' from JSON`,
  );
}

/** @internal */
export const ConcatRequest$inboundSchema: z.ZodType<
  ConcatRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  access_mode: ConcatRequestAccessMode$inboundSchema.optional(),
...
/** @internal */
export type ConcatRequest$Outbound = {
...
/** @internal */
export const ConcatRequest$outboundSchema: z.ZodType<
  ConcatRequest$Outbound,
  z.ZodTypeDef,
  ConcatRequest
> = z.object({
  ...
  accessMode: ConcatRequestAccessMode$outboundSchema.optional(),
  backup: z.boolean().optional(),
...
export function concatRequestToJSON(concatRequest: ConcatRequest): string {
  return JSON.stringify(ConcatRequest$outboundSchema.parse(concatRequest));
}
export function concatRequestFromJSON(
  jsonString: string,
): SafeParseResult<ConcatRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ConcatRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ConcatRequest' from JSON`,
  );
}
