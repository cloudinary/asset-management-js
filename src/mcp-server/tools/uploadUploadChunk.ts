...
import { uploadUploadChunk } from "../../funcs/uploadUploadChunk.js";
...
export const tool$uploadUploadChunk: ToolDefinition<typeof args> = {
  name: "upload-upload-chunk",
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await uploadUploadChunk(
      client,
      args.resourceType,
      args.contentRange,
