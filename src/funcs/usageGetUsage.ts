...
> {
  const input: operations.GetUsageRequest = {
    date: date,
  };

  const parsed = safeParse(
    input,
    (value) => operations.GetUsageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/usage")(pathParams);
