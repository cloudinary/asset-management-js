...
export function backupsDeleteBackupVersions(
  ...
  Result<
    operations.DeleteBackupVersionsResponse,
    | errors.ApiError
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteBackupVersionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteBackupVersionsResponse$inboundSchema),
    M.json(207, operations.DeleteBackupVersionsResponse$inboundSchema),
