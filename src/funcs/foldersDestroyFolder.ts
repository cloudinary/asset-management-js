...
export function foldersDestroyFolder(
  ...
  Result<
    operations.DestroyFolderResponse,
    | errors.ApiError
...
> {
  const input: operations.DestroyFolderRequest = {
    folder: folder,
  };

  const parsed = safeParse(
    input,
    (value) => operations.DestroyFolderRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DestroyFolderResponse$inboundSchema),
