...
> {
  const input: operations.ListVideosRequest = {
    type: type,
    prefix: prefix,
    publicIds: publicIds,
    tags: tags,
  ...
  const parsed = safeParse(
    input,
    (value) => operations.ListVideosRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/resources/video")(pathParams);
