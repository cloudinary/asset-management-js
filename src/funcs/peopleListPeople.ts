...
> {
  const input: operations.ListPeopleRequest = {
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/people")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PeopleListResponse$inboundSchema),
