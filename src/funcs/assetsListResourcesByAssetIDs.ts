...
> {
  const input: operations.ListResourcesByAssetIDsRequest = {
    assetIds: assetIds,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListResourcesByAssetIDsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/resources/by_asset_ids")(
    pathParams,
  );
