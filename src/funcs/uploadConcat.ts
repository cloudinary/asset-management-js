...
> {
  const parsed = safeParse(
    request,
    (value) => components.ConcatRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/video/concat")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ConcatResponse$inboundSchema),
