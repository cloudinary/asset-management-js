...
export function assetsListResourcesByContainerId(
  ...
  Result<
    components.ResourcesByContainerIdResponse,
    | errors.ApiError
...
> {
  const input: operations.ListResourcesByContainerIdRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListResourcesByContainerIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ResourcesByContainerIdResponse$inboundSchema),
