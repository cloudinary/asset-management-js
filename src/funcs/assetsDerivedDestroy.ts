...
> {
  const parsed = safeParse(
    request,
    (value) => components.DerivedDestroyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/derived_resources")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.DerivedDestroyResponse$inboundSchema),
