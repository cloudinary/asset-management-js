...
export function videoAnalyticsGetVideoViews(
  ...
  Result<
    operations.GetVideoViewsResponse,
    | errors.ApiError
...
> {
  const input: operations.GetVideoViewsRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetVideoViewsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetVideoViewsResponse$inboundSchema),
