...
> {
  const input: operations.ListRawFilesRequest = {
    type: type,
    prefix: prefix,
    publicIds: publicIds,
    tags: tags,
  ...
  const parsed = safeParse(
    input,
    (value) => operations.ListRawFilesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/resources/raw")(pathParams);
