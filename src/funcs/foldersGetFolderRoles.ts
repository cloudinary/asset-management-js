...
export function foldersGetFolderRoles(
  ...
  Result<
    components.FolderRolesResponse,
    | errors.ApiError
...
> {
  const input: operations.GetFolderRolesRequest = {
    folderId: folderId,
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetFolderRolesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.FolderRolesResponse$inboundSchema),
