...
export function uploadUploadNoResourceType(
  ...
  Result<
    operations.UploadNoResourceTypeResponse,
    | errors.ApiError
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => components.UploadRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UploadNoResourceTypeResponse$inboundSchema),
    M.text(302, operations.UploadNoResourceTypeResponse$inboundSchema, {
      ctype: "text/html",
    }),
