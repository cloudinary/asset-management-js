...
export function initialBackupCreateInitialBackup(
  ...
  Result<
    components.InitialBackupCreateResponse,
    | errors.ApiError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.InitialBackupCreateRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.InitialBackupCreateResponse$inboundSchema),
