...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RestoreResourcesByAssetIDsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/resources/restore")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.record(components.RestoreResponseUnion$inboundSchema)),
