...
> {
  const input: operations.GetGenerationTaskStatusRequest = {
    taskId: taskId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetGenerationTaskStatusRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.TaskResponse$inboundSchema),
