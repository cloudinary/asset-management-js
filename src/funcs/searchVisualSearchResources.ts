 ...
 */
export function searchVisualSearchResources(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.VisualSearchParametersUnion$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/resources/visual_search")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "visualSearchResources",
    oAuth2Scopes: [],
