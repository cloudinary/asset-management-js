 ...
 */
export function assetsListResourcesByExternalIDs(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListResourcesByExternalIDsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/resources/by_external_ids")(
    pathParams,
  );
