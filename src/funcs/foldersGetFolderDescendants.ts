...
export function foldersGetFolderDescendants(
  ...
  Result<
    components.FolderDescendantsResponse,
    | errors.ApiError
...
> {
  const parsed = safeParse(
    request,
    (value) => components.FolderDescendantsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/folders/descendants")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.FolderDescendantsResponse$inboundSchema),
