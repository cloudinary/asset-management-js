 ...
 */
export function searchSearchResourcesPost(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.SearchParameters$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/resources/search")(pathParams);
