...
```typescript
import { ExplicitRequestAccessMode } from "@cloudinary/asset-management/models/components";

let value: ExplicitRequestAccessMode = "public";
```
