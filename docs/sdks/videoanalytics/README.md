...
| `sortBy`                                                                                                                                                                       | [operations.GetVideoViewsSortBy](../../models/operations/getvideoviewssortby.md)                                                                                               | :heavy_minus_sign:                                                                                                                                                             | Specifies the expression field by which to sort the results. Prepend values with a '-' to reverse the order.                                                                   |
...
**Promise\<[components.VideoViewsResponse](../../models/components/videoviewsresponse.md)\>**
