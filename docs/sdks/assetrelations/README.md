...
async function run() {
  const result = await cloudinaryAssetMgmt.assetRelations.createAssetRelationsByAssetId("f4e6579cf84dd9cf5683b21f5b30c7d9", {
    assetsToRelate: [
      "f12345a5c789c",
      "bbb0efc00c0f12",
    ],
...
async function run() {
  const res = await assetRelationsCreateAssetRelationsByAssetId(cloudinaryAssetMgmt, "f4e6579cf84dd9cf5683b21f5b30c7d9", {
    assetsToRelate: [
      "f12345a5c789c",
      "bbb0efc00c0f12",
    ],
...
async function run() {
  const result = await cloudinaryAssetMgmt.assetRelations.deleteAssetRelationsByAssetId("f4e6579cf84dd9cf5683b21f5b30c7d9", {
    assetsToUnrelate: [
      "f12345a5c789c",
      "bbb0efc00c0f12",
    ],
...
async function run() {
  const res = await assetRelationsDeleteAssetRelationsByAssetId(cloudinaryAssetMgmt, "f4e6579cf84dd9cf5683b21f5b30c7d9", {
    assetsToUnrelate: [
      "f12345a5c789c",
      "bbb0efc00c0f12",
    ],
...
async function run() {
  const result = await cloudinaryAssetMgmt.assetRelations.createAssetRelationsByPublicId("raw", "upload", "sample", {
    assetsToRelate: [
...
async function run() {
  const res = await assetRelationsCreateAssetRelationsByPublicId(cloudinaryAssetMgmt, "raw", "upload", "sample", {
    assetsToRelate: [
      "raw/upload/dog_subtitles.srt",
      "image/authenticated/dog_license",
    ],
...
async function run() {
  const result = await cloudinaryAssetMgmt.assetRelations.deleteAssetRelationsByPublicId("raw", "upload", "sample", {
    assetsToUnrelate: [
      "raw/upload/dog_subtitles.srt",
      "image/authenticated/dog_license",
    ],
...
async function run() {
  const res = await assetRelationsDeleteAssetRelationsByPublicId(cloudinaryAssetMgmt, "raw", "upload", "sample", {
    assetsToUnrelate: [
      "raw/upload/dog_subtitles.srt",
      "image/authenticated/dog_license",
    ],
